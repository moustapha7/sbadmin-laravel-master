                ...
                <div class="card-body ml-4">
                    <form method="POST" action="{{ route('createTask') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div>Comments</div>
                                <textarea id="comment" class="form-control{{ $errors->has('comment') ? ' is-invalid' : '' }}" name="comment" rows="1">
                        ...
                        <div class="form-group row">
                            ...
                            <div>Requested Date</div>
                                <input id="requestedDate" type="date" class="form-control{{ $errors->has('requestedDate') ? ' is-invalid' : '' }}" name="requestedDate" required="required">
                            ...
                            <div>Est. Completed Date</div>
                                <input id="estcompletedDate" type="date" class="form-control{{ $errors->has('estcompletedDate') ? ' is-invalid' : '' }}" name="estcompletedDate"  required >
                                @if ($errors->has('requestedDate'))
                                    <span class="invalid-feedback">
                            ...
                            <div class="col-md-2">
                            <div>Est. Days</div>
                                <input id="estDay" type="text" class="form-control{{ $errors->has('estDay') ? ' is-invalid' : '' }}" name="estDay" disabled>
                            ...
                            <div class="col-md-2">
                            <div>Est. Hours</div>
                                <input id="estHour" type="text" class="form-control{{ $errors->has('estHour') ? ' is-invalid' : '' }}" name="estHour"  disabled>
                                @if ($errors->has('estDay'))
                                    <span class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                <div>Assigned To </div>
                                <select name="employe" id="employe" class="form-control{{ $errors->has('employe') ? ' is-invalid' : '' }}">
                                    @if(!empty($employes))
